...
public class SOMNet
{
	...
	blocks = new Block[MAXNUMBEROFBLOCKS];
    ...
    public void drawNet(Graphics graphics_1_21_, Dimension dimension_2_22_, Color background) {
	for (int i_3_23_ = 0; i_3_23_ < MAXNUMBEROFBLOCKS; i_3_23_++)
	    blocks[i_3_23_].drawBlock(graphics_1_21_, dimension_2_22_,background);
	for (int i_5_27_ = 0; i_5_27_ < netsize; i_5_27_++) {
	    net[i_5_27_].drawUnit(graphics_1_21_, 
				  dimension_2_22_,
				  background);
	}
	for (int i_4_24_ = 0; i_4_24_ < netsize; i_4_24_++) {
		...
		net[i_4_24_].drawLink(graphics_1_21_, dimension_2_22_, 
				      (Unit) vector_5_25_.elementAt(i_6_26_),
				      background);
	}
	for (int i_5_27_ = 0; i_5_27_ < netsize; i_5_27_++) {
	    net[i_5_27_].storeWeights();
	}
    }
    
    public boolean validInput(Input input_1_29_) {
	for (int i_2_30_ = 0; i_2_30_ < MAXNUMBEROFBLOCKS; i_2_30_++) {
	...
	blocks[i_1_32_].isShown = true;
    }
    
    public void deleteBlock(int i_1_32_) {
	blocks[i_1_32_].isShown = false;
    }
